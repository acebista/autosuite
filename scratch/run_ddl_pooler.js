...
const connectionString = 'postgresql://postgres.tjjxrfiorfboknnaxevz:JZ08otMF8VHVXnhjiLbNYgAw15fJsVWXVFKAIr2xsSk@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres';
...
async function run() {
  ...
  try {
    console.log('Connecting to database via ap-northeast-2 (Seoul) pooler...');
